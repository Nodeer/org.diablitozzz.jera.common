...
public class JsonUtilObject {
    ...
    public static Boolean toBooleanObject(final Object value) {
        ...
        return Boolean.valueOf(JsonUtilObject.toBoolean(value));
    }
    
    public static Calendar toCalendar(final Object value) {
        return JsonUtilObject.toCalendar(value, JsonUtilObject.simpleDateFormat);
    ...
    public static Calendar toCalendar(final Object value, final DateFormat dateFormat) {
        ...
        final java.util.Date date = JsonUtilObject.toDate(value, dateFormat);
    ...
    public static java.util.Date toDate(final Object value) {
        return JsonUtilObject.toDate(value, JsonUtilObject.simpleDateFormat);
    }
    ...
    public static Double toDoubleObject(final Object value) {
        ...
        return Double.valueOf(JsonUtilObject.toDouble(value));
    }
    
    public static <T> T toEnum(final Object value, final Class<T> enumClass) {
        final String sValue = JsonUtilObject.toString(value);
    ...
    public static Float toFloatObject(final Object value) {
        ...
        return Float.valueOf(JsonUtilObject.toFloat(value));
    ...
    public static Integer toIntegerObject(final Object value) {
        ...
        return Integer.valueOf(JsonUtilObject.toInteger(value));
    ...
    public static Long toLongObject(final Object value) {
        ...
        return Long.valueOf(JsonUtilObject.toLong(value));
    }
    ...
    public static Long[] toLongObjectArray(final Object elements) {
        ...
        if (elements instanceof Collection) {
            ...
            for (final Object col : cols) {
                out[i] = JsonUtilObject.toLongObject(col);
                i++;
            }
            return out;
        }
        if (elements.getClass().isArray()) {
            ...
            for (int i = 0; i < size; i++) {
                out[i] = JsonUtilObject.toLongObject(Array.get(elements, i));
            }
            return out;
        }
        return null;
    ...
    public static Short toShortObject(final Object value) {
        ...
        return Short.valueOf(JsonUtilObject.toShort(value));
    }
